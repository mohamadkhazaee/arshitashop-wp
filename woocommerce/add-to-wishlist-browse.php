...
<div class="yith-wcwl-wishlistexistsbrowse">
	<span class="feedback">
		...
		<?php // echo wp_kses_post( 'مشاهده' ); ?>
	</span>
	<a title="مشاهده لیست علاقه مندی" href="<?php echo esc_url( $wishlist_url ); ?>" rel="nofollow" data-title="<?php echo esc_attr( $browse_wishlist_text ); ?>">
